...
import com.example.lorvent.popular_movie_app1.network.GetAllPopularMovies;
...
public class PopularFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new GetAllPopularMovies(recyclerView,layoutManager,getActivity(),movieArrayList).execute(AppConfig.API_KEY);
