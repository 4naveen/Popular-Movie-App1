 ...
 */
public class GetAllPopularMovies extends AsyncTask<String,Void,String>
{   String response;
    ...
    public GetAllPopularMovies(RecyclerView recyclerView, GridLayoutManager layoutManager, Context context, ArrayList<Movie> movieArrayList) {
    ...
    protected String doInBackground(String... params) {
        ...
        StringBuffer buffer;
        try {
            url = new URL(AppConfig.MOVIES_POPULAR_URL+params[0]);
